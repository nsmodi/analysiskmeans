...
The goal of analysiskmeans is to perform a K Means Clustering on a
Single Cell Experiment data object!
...
![](README_files/figure-gfm/cluster-1.png)<!-- --> \## Using
analysiskmeans in CLI
